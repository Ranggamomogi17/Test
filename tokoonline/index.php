...
<html lang="en">
  ...
  <div class="container-fluid">
   ...
   <nav class="navbar navbar-expand-lg navbar-light bg-alert alert-danger">
  <a class="navbar-brand" href="#">Rumah Bisnisku~</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link" href="#">Laporan Rugi - Laba</a>
...
<div class="jumbotron jumbotron-fluid">
  ...
  <h1 class="display-4">Rangga Momogi</h1>
    <p class="lead">
        |Konveksi | Elektronik | Marketplace|.
    </p>
    </P>
  </div>
</div>
...
<div class="container">
    ...
    <div class="row justify-content-center">
        ...
        Perkenankanlah kami dalam kesempatan ini untuk memperkenalkan diri yaitu Rumah Bisnisku~ , Sebagai perusahaan yang bergerak dibidang “Fashion” Untuk produk-produk seperti Sepatu-Sepatu Branded, Tas Brended,Baju Kaos Branded,Celana Branded, Jaket Branded, dan lain Sebagainya.<br>
